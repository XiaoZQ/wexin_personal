...
def tick():
    users = itchat.search_friends(name=u'XQ') # 找到你女朋友的名称
    ...
    nextTickTime = nextTickTime.strftime("%Y-%m-%d 22:47:00")
...
if __name__ == '__main__':
    ...
    nextTickTime = now + dt.timedelta(days=0) #下一个问候时间为明天的现在
    nextTickTime = nextTickTime.strftime("%Y-%m-%d 22:46:00") # 把下一个问候时间设定为明天的零点
